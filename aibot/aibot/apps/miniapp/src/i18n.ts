const translations = {
  ru: {
    ...
    'create.compare': 'Сравнить модели',
    'create.compareDesc': 'Один промпт через несколько моделей',
  ...
  en: {
    ...
    'create.compare': 'Compare models',
    'create.compareDesc': 'Same prompt through multiple models',
